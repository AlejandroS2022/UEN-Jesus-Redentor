...
<div id="contenedor2">	
	...
	<h1>Crear Materia</h1>
         ...
         <br/>
         <div id="planilla">
            <form method="POST" action="agregarmateria.php" id="formulario">
            ...
            <div class="row">
                ...
                <div class="input-field col s6 orange-text darken-1">
                  <input id="nombre" type="text" class="validate required" name="nombre" required="required">
                  <label for="nombre">Materia</label>
                </div>
            </div>
             <center>
                 
                   <button class="btn waves-effect waves-light orange darken-3" type="button" id="boton-form-i" name="Crear" value="Crear" style="color:white" >Crear Materia
