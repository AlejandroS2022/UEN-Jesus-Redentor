...
<div id="contenedor2">  
  ...
  <h1>Editar Estudiante</h1>
         ...
         <br/>
         <div id="planilla">
            <form method="POST" action="modificarestudiante.php" id="formulario">

              <input id="id" type="hidden" name="id"  value="<?php echo $filas['id'] ?>" required>
              <input id="id_r" type="hidden" name="id_r"  value="<?php echo $filas['id_r'] ?>" required>
...
<center><label><p style="font-size: 22px;">- Datos del representante -</p></label></center>
            ...
            <div class="row">
                <div class="input-field col s12">
                <input id="cedula_r" type="number" minlength="7" maxlength="8" class="validate required" name="cedula_r" required value="<?php echo $filas['cedula_r'] ?>">
                <label for="cedula_r">Cédula</label>
               </div>
            </div>
            <div class="row">
                <div class="input-field col s12">
                <input id="apellido_r" type="text" class="validate required" name="apellido_r" required value="<?php echo $filas['apellido_r'] ?>">
                <label for="apellido_r">Apellidos</label>
               </div>
            </div>
            <div class="row">
                <div class="input-field col s12">
                <input id="nombre_r" type="text" class="validate required" name="nombre_r" required value="<?php echo $filas['nombre_r'] ?>">
                <label for="nombre_r">Nombres</label>
               </div>
            </div>
            <div class="row">
                <div class="input-field col s12">
                <input id="direccion_r" type="text" class="validate required" name="direccion_r" required value="<?php echo $filas['direccion_r'] ?>">
            ...
            <div class="row">
                ...
                <div class="input-field col s4">
                <input id="fecha_nacimiento_r" type="date" class="validate required" name="fecha_nacimiento_r" required value="<?php echo $filas['fecha_nacimiento_r'] ?>">
                <label for="fecha_nacimiento_r">Fecha de nacimiento</label>
               </div>

                <div class="input-field col s4">
                <input id="parentesco_representante" type="text" class="validate required" name="parentesco_representante" required value="<?php echo $filas['parentesco_representante'] ?>">
                <label for="parentesco_representante">Parentesco con el estudiante</label>
               </div>
            </div>

             <center>
                   <button class="btn waves-effect waves-light orange darken-3" type="button" id="boton-form-u" name="Editar" value="Editar" style="color:white" >Editar estudiante</button>
